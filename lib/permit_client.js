...
//     cond[ROAD_NM_ADDR::LIKE]     도로명주소 부분일치  ← 지역 필터의 주력
//     cond[OPN_ATMY_GRP_CD::EQ]    개방자치단체코드 일치
 ...
 * @param {string} [o.addrLike]      도로명주소 부분일치 (예: "영등포구")
...
export async function fetchPermits(o) {
  const {
    type, addrLike, orgCode, salesStatus, licenseFrom, licenseTo,
